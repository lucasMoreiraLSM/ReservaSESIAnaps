...
<p>
 Isso relatará seqüências de caracteres ausentes ou não traduzidas nos arquivos de idioma.
</p>
...
Atualizar arquivo (s) com novas linhas de token (o usuário do servidor da web requer permissão de gravação
em arquivos e diretório)
<br>
